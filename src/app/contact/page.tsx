...
import { Flame, Mail, Phone, MapPin, Send, CheckCircle, Globe, Link2, Video } from "lucide-react";
    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="text-lg text-charcoal-light max-w-lg mx-auto">Have a question, want to book Mark, or just want to say hello? Drop a message below.</p>
        </motion.div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="rounded-2xl bg-white shadow-sm border border-primary/10 p-8 md:p-10 space-y-6" noValidate>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input id="phone" type="tel" value={form.phone} onChange={(e) => handleChange("phone", e.target.value)} className="w-full rounded-xl border border-transparent bg-warm-white px-4 py-3 text-charcoal placeholder:text-slate/50 focus:outline-none focus:ring-2 focus:ring-primary/50 transition" placeholder="+64 21 000 0000" />
                  </div>
                  <div>
                ...
                <ul className="space-y-5">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+6421000000" className="text-sm font-medium text-charcoal hover:text-primary transition-colors">+64 21 000 0000</a>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-slate mb-0.5">Location</p>
                      <p className="text-sm font-medium text-charcoal">New Zealand</p>
                    </div>
                  </li>
                </ul>
              </div>
              <div className="rounded-2xl bg-white shadow-sm border border-primary/10 p-8">
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <a key={label} href={href} aria-label={label} className="flex h-11 w-11 items-center justify-center rounded-xl bg-warm-white text-charcoal-light hover:bg-primary hover:text-white transition-colors">
